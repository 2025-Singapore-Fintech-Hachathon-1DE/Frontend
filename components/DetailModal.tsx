...
import { DetailData, DetectionCase } from '../types'
            ...
            >
                <header className="flex items-center justify-between p-4 border-b border-gray-700">
                    <h2 className="text-xl font-bold text-white">
                        {detail.type === 'sanction' ? '제재 상세 정보' : detail.type === 'detection' ? '탐지 상세 정보' : '계정 상세 정보'}
                    </h2>
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    {(detail.type === 'sanction' || detail.type === 'detection') && (
                        <SanctionDetailView
